<h2> Les Dernières News du JDR</h2>
        ...
        <p>Après avoir réalisé deux campagnes avec un fort succès pour le jeu de plateau Batman : Gotham City Chronicles, l'éditeur français Monolith compte poursuivre son exploration de l'univers du Chevalier Noir avec un autre pan ludique, qui prend un essor de plus en plus important ces dernières années : le jeu de rôle...<a href="http://www.comicsblog.fr/38171-Monolith_preepare_un_jeu_de_reole_dans_lunivers_Batman_Gotham_City_Chronicles_RPG">"Lire la suite"</a> </p>
        <div class="finparaph">
